    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        ...
        <Text style={styles.paragraph}>
          By accessing and using the Popular Live mobile application ("Service"), you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the app.
        </Text>
        ...
        <Text style={styles.paragraph}>
          ...
          Popular Live reserves the right to terminate accounts that violate our safety guidelines without prior notice.
        </Text>
        ...
        <Text style={styles.paragraph}>
          VIP and VVIP subscriptions provide enhanced account features. Fees are non-refundable once the subscription is activated. Popular Live reserves the right to modify subscription perks at any time.
        </Text>
        ...
        <Text style={styles.paragraph}>
          In no event shall Popular Live or its developers be liable for any indirect, incidental, or consequential damages arising out of your use of the application.
        </Text>
