-- =====================================================================
-- 114_greedy_lion_uncapped_payout_range.sql
-- Greedy Lion payout range can exceed 100% when admin config requires it.
-- =====================================================================
...
BEGIN
  ...
  v_target_min_percent := GREATEST(0, COALESCE((v_rules->>'target_payout_min_percent')::numeric, COALESCE(v_settings.win_chance_percent, 30)));
  v_target_max_percent := GREATEST(0, COALESCE((v_rules->>'target_payout_max_percent')::numeric, GREATEST(v_target_min_percent, COALESCE(v_settings.win_chance_percent, 30))));
